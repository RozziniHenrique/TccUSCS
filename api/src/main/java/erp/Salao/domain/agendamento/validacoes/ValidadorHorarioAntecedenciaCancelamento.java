...
public class ValidadorHorarioAntecedenciaCancelamento
  implements ValidadorCancelamentoAgendamento
{
  ...
  public void validar(CancelarAgendamentoDTO dados) {
    var agendamento = repository
      ...
      .orElseThrow(() ->
        new ValidacaoException("Id do agendamento informado não existe!")
      );
    ...
    if (diferencaEmHoras < 2) {
      throw new ValidacaoException(
        "Agendamento somente pode ser cancelado com antecedência mínima de 2h!"
      );
    }
  }
}
