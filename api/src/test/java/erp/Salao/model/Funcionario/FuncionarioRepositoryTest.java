...
class FuncionarioRepositoryTest {
  ...
  void deveriaRetornarNull_cenario01() {
    ...
    var funcionarioLivre =
      funcionarioRepository.escolherFuncionarioAleatorioLivreNaData(
        especialidade.getId(),
        proximaSegunda10am
      );
  ...
  @Test
  @DisplayName(
    "Cenário 2: Especialista disponível -> Deve retornar o especialista"
  )
  void deveriaRetornarEspecialista_cenario02() {
    ...
    var funcionario = cadastrarFuncionario(
      "Henrique Teste",
      "henrique@email.com",
      "12345678901",
      especialidade
  ...
  @Test
  @DisplayName(
    "Cenário 4: Especialista disponível mas com especialidade diferente -> Deve retornar null"
  )
  void deveriaRetornarNull_cenario04() {
    ...
    var especialidadeDoFuncionario = cadastrarEspecialidade(
      "Depilação",
      "Descricao"
    );
    em.flush();
    ...
    cadastrarFuncionario(
      "Henrique Especialista em Outra Coisa",
      "henrique@email.com",
      "12345678901",
      especialidadeDoFuncionario
    );
    var funcionarioLivre =
      funcionarioRepository.escolherFuncionarioAleatorioLivreNaData(
        especialidadeBuscada.getId(),
        proximaSegunda10am
      );
  ...
  private Especialidade cadastrarEspecialidade(String nome, String descricao) {
    var dados = new CadastrarEspecialidadeDTO(
      "Corte",
