...
@Component
public class ValidadorDuplicidadeAgendamentoFuncionario
  implements ValidadorAgendamento
{
  ...
  public void validar(CadastrarAgendamentoDTO dados) {
    ...
    var possuiAgendamento =
      repository.existsByFuncionarioIdAndDataAndMotivoCancelamentoIsNull(
        dados.idFuncionario(),
        dados.data()
      );
    if (possuiAgendamento) {
      throw new ValidacaoException(
        "Funcionário já possui outro agendamento nesse mesmo horário!"
      );
    }
  }
}
