...
class ValidadorHorarioFuncionamentoTest {
  ...
  private ValidadorHorarioFuncionamento validador =
    new ValidadorHorarioFuncionamento();
  ...
  void validar_cenario01() {
    ...
    assertThat(
      exception.getMessage().contains("Fora do horário de funcionamento")
    );
  }

  @Test
  @DisplayName(
    "Cenário 2: Agendamento antes da abertura(6h) -> Deve lançar exceção"
  )
  ...
  @Test
  @DisplayName(
    "Cenário 3: Agendamento em horário válido -> NÃO deve lançar exceção"
  )
