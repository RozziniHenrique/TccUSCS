  ...
  extends JpaRepository<Funcionario, Long>
{
  ...
  Page<Funcionario> findAllByAtivoTrueAndEspecialidadesId(
    Long especialidadeId,
    Pageable paginacao
  );

  Page<Funcionario> findAllByAtivoFalseAndEspecialidadesId(
    Long especialidadeId,
    Pageable paginacao
  );
  ...
  Funcionario escolherFuncionarioAleatorioLivreNaData(
