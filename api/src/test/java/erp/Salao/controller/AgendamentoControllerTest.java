...
class AgendamentoControllerTest {
  ...
  void agendar_cenario01() throws Exception {
    var response = mvc
      .perform(
        post("/agendamentos")
          .with(
            user("usuario-teste").authorities(
  ...
  void agendar_cenario02() throws Exception {
    var proximaSegunda10am = LocalDateTime.now()
      ...
      .withSecond(0)
      .withNano(0);
    var dadosAgendamento = new CadastrarAgendamentoDTO(
      3L,
      3L,
      3L,
      proximaSegunda10am
  ...
  @Test
  @DisplayName(
    "Cenário 3: Cancelar agendamento com informações válidas -> Deve retornar http 204"
  )
  @WithMockUser(authorities = "ADMIN")
  void cancelar_cenario01() throws Exception {
    var dadosCancelamento = new CancelarAgendamentoDTO(
      1L,
      "O cliente desistiu"
    );
