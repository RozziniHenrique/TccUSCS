...
import uscs.STEFER.model.Dashboard.AlertaQualidade;
import uscs.STEFER.model.Dashboard.RankingFuncionario;
...
public interface AgendamentoRepository extends JpaRepository<Agendamento, Long> {
    ...
    @Query("""
                SELECT new uscs.STEFER.model.Dashboard.RankingFuncionario(f.nome, COUNT(a))
                FROM Agendamento a
    ...
    @Query("""
                SELECT new uscs.STEFER.model.Dashboard.AlertaQualidade(f.nome, AVG(a.nota))
                FROM Agendamento a
                JOIN a.funcionario f
